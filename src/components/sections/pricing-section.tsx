...
export function PricingSection() {
  const plans = [
    {
      name: "Малая партия",
      description: "Для небольших заказов — попробовать или закрыть срочную потребность.",
      price: "от 150 ₽",
      duration: "за шеврон",
      features: [
        "От 10 до 50 штук",
        "Шевроны / нашивки / ремувки",
        "Помощь с макетом",
        "Срок 1–2 дня",
        "Отправка в день готовности",
      ],
      cta: "Заказать",
      popular: false,
    },
    {
      name: "Средняя партия",
      description: "Оптимальный вариант — сниженная цена и гарантированные сроки.",
      price: "от 120 ₽",
      duration: "за шеврон",
      features: [
        "От 50 до 300 штук",
    ...
    {
      name: "Крупный заказ",
      description: "Для корпоративных и оптовых поставок — максимальная выгода.",
      price: "от 80 ₽",
      duration: "за шеврон",
      features: [
        "От 300 штук",
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              <h2 className="text-3xl font-heading font-bold tracking-tighter sm:text-5xl">
                Цены зависят от объёма
              </h2>
              <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400 opacity-70">
                Чем больше партия — тем ниже цена за штуку. Оставьте заявку и получите точный расчёт.
              </p>
            </div>
          </div>
        </ScrollReveal>
